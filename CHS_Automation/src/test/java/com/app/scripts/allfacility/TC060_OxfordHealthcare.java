...
public class TC060_OxfordHealthcare       extends DriverTestCase {
String rthExpectedText="65|26.53%";

@Test
public void oxfordhealthcare() throws InterruptedException {
...
//Navigate
String facilityName= "Oxford Healthcare";
